...
import { getStoredId, getStoredName } from "../../shared/helpers/localStorage/localStorageHelpers";
import { notifyError, notifySuccess } from "../../shared/helpers/notificationHelpers";
import { useAppDispatch, useAppSelector } from "../../states/app/hooks";
import { findUser, userSelector } from "../../states/features/userSlice";
...
export const EditUser = () => {
  ...
  const { value: userValue } = useAppSelector(userSelector);
